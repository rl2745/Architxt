...
type expr =
  ...
  | PixelAssign of string * ptyp * expr
  | PixelAccess of string * ptyp
...
let rec string_of_expr = function
  ...
  | PixelAssign(id, t, e) -> id ^ "." ^ string_of_ptyp t ^ "=" ^ string_of_expr e
  | PixelAccess(id, t) -> id ^ "." ^ string_of_ptyp t
